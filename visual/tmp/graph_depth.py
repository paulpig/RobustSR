...
fig, ax_list = plt.subplots(ncols=1, nrows=1, figsize=(8,6))
...
#         y4 = [0.3875, 0.4225] #crbiaSR
        ...
        # y3 = [1.297, 0.826, 0.815, 0.741, 0.698]
        y1 = [0.17913, 0.17917, 0.17975, 0.20038, 0.20208, 0.20147, 0.20136]
        y2 = [0.18174, 0.18185, 0.18219, 0.20353, 0.20521, 0.20473, 0.20452]
        y3 = [0.22074, 0.22007, 0.22167, 0.24552, 0.24746, 0.24738, 0.24663]
...
#         y4 = [0.4860, 0.6200] #crbiaSR
        ...
        # remove 20
        y1 = [0.08286, 0.08318, 0.08192, 0.08127, 0.08058, 0.07993, 0.07992]
        y2 = [0.10868, 0.10960, 0.10755, 0.10695, 0.10414, 0.10457, 0.10300]
        y3 = [0.12723, 0.12686, 0.12424, 0.12326, 0.12017, 0.12019, 0.11903]
...
#         dataset = '(c) Amazon Toys'
    ...
    ax.plot(x,[item*100 for item in y2[::-1]],'r*-',label='R@10', linewidth=3, markersize=8)
    ax.plot(x,[item*100 for item in y3[::-1]],'gd-',label='N@10', linewidth=3, markersize=8)
