...
LightGCN model
"""
class LightGCN_delicious(GraphRecommender):
    def __init__(self,conf,trainingSet=None,testSet=None,fold='[1]'):
        super(LightGCN_delicious, self).__init__(conf,trainingSet,testSet,fold)
        args = OptionConf(self.config['LightGCN_delicious'])
        self.n_layers = int(args['-n_layer'])
        # pdb.set_trace()

    def initModel(self):
        super(LightGCN_delicious, self).initModel()
        #SEPT对齐, 修正初始化.
