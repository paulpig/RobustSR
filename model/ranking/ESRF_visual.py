...
class ESRF_visual(SocialRecommender,GraphRecommender):
    ...
    def readConfiguration(self):
        super(ESRF_visual, self).readConfiguration()
        args = config.OptionConf(self.config['ESRF_visual'])
    ...
    def initModel(self):
        super(ESRF_visual, self).initModel()
        self.listed_data = []
        for i in range(self.num_users):
